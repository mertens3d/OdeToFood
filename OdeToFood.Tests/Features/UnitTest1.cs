...
// but for starters we'll allow an administrators to toggle between two
...
// Overall the rating should be a whole number.
...
namespace OdeToFood.Tests.Features
{
    ...
    public class UnitTest1
    {
        ...
        {
            var data = BuildRestaurantAndReviews(ratings: new[] { 4 });
        ...
        public void Rating_Includes_Only_First_N_Reviews()
        {
            ...
            var rater = new RestaurantRater(data);
            var result = rater.ComputeResult(new WeightedRatingAlgorithm(), 3);
